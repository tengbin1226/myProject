...
public class CodeGenerator {
    /**
     * JDBC配置，根据实际情况修改为你项目的实际配置
     * <p>
     * nullCatalogMeansCurrent=true使用com.mysql.cj.jdbc.Driver这个驱动的时候，要加上这个属性。
     * 在项目中不需要加，但是在使用Mybatis Generator时要加上
     */
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/project_seed?characterEncoding=utf8&useSSL=false&serverTimezone=UTC&rewriteBatchedStatements=true&nullCatalogMeansCurrent=true";
